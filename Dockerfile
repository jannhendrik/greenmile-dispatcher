...
COPY ./letsencrypt/index.html /usr/share/nginx/html
COPY ./letsencrypt/mime.types /etc/nginx

#Configure nginx - moved to runtime because files are genrated from env params
